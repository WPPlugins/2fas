...
class TwoFAS_Enable_SMS extends TwoFAS_Enable_Channel
{
    /**
     * @var string
     */
    protected $action_id = TwoFAS_Action_Map::TWOFAS_ACTION_ENABLE_SMS;

    /**
     * @var string
     */
    protected $success_notification_key = 's-enable-sms';

    /**
     * @var string
     */
    protected $error_notification_key = 'e-enable-sms';
    ...
    {
        return $userdata->get_sms_status() === TwoFAS_WP_Userdata_Storage::TWOFAS_METHOD_CONFIGURED_DISABLED;
    }
    ...
    {
        $user_data->set_sms_as_configured_enabled();
        $user_data->set_sms_as_auth_method();
    }
