...
class TwoFAS_Enable_Call_Globally extends TwoFAS_Enable_Channel_Globally
{
    /**
     * @var string
     */
    protected $action_id = TwoFAS_Action_Map::TWOFAS_ACTION_ENABLE_CALL_GLOBALLY;

    /**
     * @var string
     */
    protected $success_notification_key = 's-enable-call-globally';

    /**
     * @var string
     */
    protected $error_notification_key = 'e-enable-call-globally';
    ...
    protected function enable_channel(
        ...
        return $authentication_channels->enable_call();
    }
}
