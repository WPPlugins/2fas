...
abstract class TwoFAS_Force_Disable_Channel_Globally extends TwoFAS_Action
{    
    /**
     * @var string
     */
     ...
     * @return Integration
     */
    protected abstract function force_disable_channel(
    ...
    public function execute_own_strategy(TwoFAS_App $app)
    {
        if ($app->get_request()->is_valid_action_call($this->action_id)) {
            try {
                $integration = $this->force_disable_channel(
