...
class TwoFAS_Disable_Totp_Globally extends TwoFAS_Disable_Channel_Globally
{
    /**
     * @var string
     */
    protected $action_id = TwoFAS_Action_Map::TWOFAS_ACTION_DISABLE_TOTP_GLOBALLY;

    /**
     * @var string
     */
    protected $success_notification_key = 's-disable-totp-globally';

    /**
     * @var string
     */
    protected $error_notification_key = 'e-disable-totp-globally';
    ...
    protected function disable_channel(
        ...
        return $authentication_channels->disable_totp();
    }
}
